functions{
 ...
 // "prob_x2_given_x1": probability mass function of x2 given x1
 // Input: x=(x1,x2), beta_1, beta_2, theta, Rqn
...
// x1 is the r.v. to be generated
parameters{
  vector<lower=0,upper=1>[p1] x1 ;
}
model{
  target += log_exp_con_lpdf(x1 | theta, beta_1, beta_2, Rqn);
}
// x2 is generated based on the multinimoal distribution of x2
// given x1
generated quantities{
  int x2 ;
  x2 = categorical_rng(prpb_x2_given_x1(x1,theta,beta_1,beta_2,Rqn)) ;
}
